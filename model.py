...
class HalfUNet(nn.Module):
    def __init__(self, input_channels=3):
        ...
        self.conv_up3 = nn.Conv2d(cfg.filter_val, cfg.filter_val * 16, 1, bias=False)
        self.up3 = nn.PixelShuffle(4)
        self.conv_up2 = nn.Conv2d(cfg.filter_val, cfg.filter_val * 4, 1, bias=False)
        self.up2 = nn.PixelShuffle(2)
        self.final_conv = nn.Conv2d(cfg.filter_val, 3, kernel_size=1)
